---
layout: post
title: ボイスプロモーション株式会社の童謡音源についてのまとめ（2023/11/13更新）
tags: その他
...
* ボイスプロモーション制作と思われる童謡（Vo.1、Vo.5の後半）
* 海沼実作品集の音源（Vo.5の後半）
...
サウンド東京のカセットテープ「海沼実作品集」などに収録されている音源。
音多になったものを含めて、ボイスプロモーションが携わったカセットやCDにも収録されている。
制作元は不明。

なお、配信されているのは音多をモノラルに編集したものらしく、ガイドメロディーが入っている。
...
これらの音源の一部は、CD「どうよう～心のうた～」にも収録されている。
...
* 音源の分類として「海沼実作品集の音源」を追加し、「ボイスプロモーション制作と思われる童謡」から一部の楽曲を移動

#### 2023/09/25

* 参考音源に「どうようBEST30」の第1集と第3集を追加
* みみちゃんレコードの未配信音源一覧に「グッドバイ」と「どじょっこふなっこ」を追加
* 「その他」の音源一覧に「子守唄」を追加
